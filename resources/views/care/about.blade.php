...
<div class="slide-item overlay" style="background-image: url('{{url('/elder')}}/images/slider-2.jpg')">
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-lg-7">
                <div class="section-heading">
                    ...
                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore perspiciatis
                        deleniti,
                        maiores quia aliquam, odit iure aspernatur voluptate delectus ipsa.</p>
            ...
            <div class="col-lg-5">
                ...
                <div class="d-block custom-media algin-items-stretch">
                    ...
                    <div class="img-bg" style="background-image: url('{{url('/elder')}}/images/img_2.jpg')"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-7 text-center mx-auto">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis fuga quas ut molestiae totam porro
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="d-block d-flex custom-media algin-items-stretch">
                    ...
                    <div class="img-bg" style="background-image: url('{{url('/elder')}}/images/img_3.jpg')"></div>
                </div>
            </div>
        </div>
    </div>
