...
<div class="slide-item overlay" style="background-image: url('/elder/images/slider-2.jpg')">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-6 align-self-center">
                <h1 class="heading mb-3">Contact us - Care Pal</h1>
