            ...
            <div class="col-md-8">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="experience_years" id="experience_years" min="0" class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label class="text-black" for="subject">Hourly Rate</label>
                        <input type="number" name="hourly_rate" id="hourly_rate" min="0" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-4">
